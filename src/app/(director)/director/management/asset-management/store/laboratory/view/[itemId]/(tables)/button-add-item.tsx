...
export default function ButtonAddItem({
  ...
  const singleItemMutation = useAddSingleItemMutation(laboratoryItem);
  const multipleItemMutation = useAddMultipleItemMutation(laboratoryItem);
