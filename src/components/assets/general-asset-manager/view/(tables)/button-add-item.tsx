...
export default function ButtonAddItem({
  ...
  const singleItemMutation = useAddSingleItemMutation(generalStoreItem);
  const multipleItemMutation = useAddMultipleItemMutation(generalStoreItem);

  const form = useForm<ItemSchema>({
    resolver: zodResolver(itemSchema),
    defaultValues: {
      parentId: generalStoreItem.id,
      quantity: undefined,
    },
  });
        ...
        <LoadingButton
          ...
          onClick={() =>
            singleItemMutation.mutate({
              input: {
                id: cuid(),
                generalStoreItemId: generalStoreItem.id,
